...
class LibCrypto {
    ...
    static createWalletFromSHA(seedsha) {
        return WalletLib.createWalletFromSHA(seedsha);
    }
    ...
    static signMessage(seedsha256, message, difficulty) {
        return WalletLib.signMessage(seedsha256, message, difficulty);
    }
